...
You see only the task statement and the diff you are pointed at; judge the change
against the task and the surrounding code, not against anyone's explanation of it.
